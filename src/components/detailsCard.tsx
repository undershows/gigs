...
export const DetailsCard: NextPage<{ show: Show }> = ({ show }) => {
  ...
  return (
    <div className="flex flex-col justify-center content-center items-center my-32 mx-auto h-full lg:flex-row lg:my-0 lg:mx-6">
      <div
        id="profile"
        className="mx-6 bg-white rounded-lg shadow-2xl opacity-75 lg:mr-2 lg:w-2/5 lg:rounded-r-none lg:rounded-l-lg"
      >
        <div className="p-4 text-center lg:p-12 lg:text-left">
          ...
          <p className="flex justify-center items-center pt-2 text-base font-bold lg:justify-start">
            <svg className="pr-4 h-4 text-black fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <div className="pt-12 pb-8">
            <button className="py-2 px-4 font-bold text-white bg-black hover:bg-black rounded-full">
              Get In Touch
            </button>
          </div>
          <div className="flex flex-wrap justify-between items-center pb-16 mx-auto mt-6 w-4/5 lg:pb-0 lg:w-full">
            <a href="#" data-tippy-content="@facebook_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a href="#" data-tippy-content="@twitter_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a href="#" data-tippy-content="@github_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a href="#" data-tippy-content="@unsplash_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a href="#" data-tippy-content="@dribble_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a href="#" data-tippy-content="@instagram_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a href="#" data-tippy-content="@youtube_handle">
              <svg
                className="h-6 text-gray-600 hover:text-black fill-current"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="relative mx-6 mt-6 w-11/12 h-full lg:ml-2 lg:w-3/5 lg:max-w-2xl">
        <Image
          src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/${convertedDate.getFullYear()}/${
            convertedDate.getMonth() + 1
          }/${show.img}`}
          className="object-contain rounded-none shadow-2xl lg:rounded-lg"
          alt="aeae"
          loader={imageLoader}
        />
      </div>
