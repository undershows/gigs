...
export const DetailsCard: NextPage<{ show: Show }> = ({ show }) => {
  ...
  return (
    <div className="mx-auto my-32 flex h-screen flex-col content-center items-center justify-center lg:mx-6 lg:my-0 lg:h-full lg:flex-row">
      <div
        id="profile"
        className="mx-6 rounded-lg bg-white opacity-75 shadow-2xl lg:mr-2 lg:w-2/5 lg:rounded-l-lg lg:rounded-r-none"
      >
        <div className="p-4 text-center lg:p-12 lg:text-left">
          ...
          <p className="flex items-center justify-center pt-2 text-base font-bold lg:justify-start">
            <svg
              className="h-4 fill-current pr-4 text-green-700"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
      ...
      <div className="relative mx-6 mt-6 h-screen w-11/12 lg:ml-2 lg:w-3/5 lg:max-w-2xl">
        <Image
